...
Índice
1.- High Concept	2
2.- Conceptos destacados	2
2.1.- Género	2
2.2.- Estilo visual	2
2.3.- Propósito y público objetivo	2
3.- Diseño narrativo	2
3.1.- Historia	2
3.2.- World Description Document	3
3.3.- Character Description Document	3
4.- Personajes	4
5.- Gameplay	5
5.1.- GameFlow	5
5.2.- Condición de victoria y derrota	5
6.- Arte	5
7.- Interfaz de usuario y controles de juego	6
7.1.- Interfaz de usuario	6
7.2.- Controles de juego	7
8.- Sonido y música	8
9.- Conectividad en Red	8
10.- Planes para el futuro	8
...
2.- Conceptos destacados
	Nuestro juego está basado en una estética ochentera en donde las peleas callejeras de aquellos años eran cruentas y sin escrúpulos. En donde los barrios se organizaban en bandas carismáticas y se peleaban por el control de territorios. Dentro de este ambiente, en “Beat the Other” encontrarás un juego de peleas diferente, inspirado en las mecánicas de juegos de baile de las recreativas para conseguir peleas y ritmos frenéticos en donde fallar un combo puede suponer la derrota. 
2.1.- Género
	En “Beat the Other” hemos querido mezclar varios estilos y dales un mismo sentido, en el que los jugadores de aquellos gamberros “Beat’em up” de recreativas y los jugadores de “Fighter games” se sentirán a gusto. Donde los jugadores más casuales pueden ser rivales a la altura de los jugadores más experimentados, planteando una mecánica clásica pero divertida. Es por ello por lo que también lo identificamos dentro del estilo de juegos como “Dance Dance Revolution”. Finalmente lo visualizamos como juego de peleas 2D de recreativas. 
2.2.- Estilo visual
	“Beat the Other” es un juego con estilo visual 2D y píxel art donde los personajes tendrán mucho protagonismo. Por tanto, queremos destacar su estilo por su sencillez y eficacia.
2.3.- Propósito y público objetivo
Con “Beat the Other” pretendemos hacer que el jugador tenga una experiencia de tensión desenfrenada a través de un gameplay con un ritmo rápido en donde las peleas sean cortas pero intensas, haciendo que tengas ganas de enfrentarte a un combate tras otro. 
...
3.- Diseño narrativo
3.1.- Historia
El juego se desarrolla en la ciudad ficticia de Gangtown, un núcleo económico y social del país. En esta ciudad conviven cuatro bandas criminales que pelean por el control de las zonas desde hace décadas, protagonizando escaramuzas, actos vandálicos y masacres que en más de una ocasión se han llevado por delante vidas civiles.
...
Al tener la intención de representar distintas culturas, además de incluir los típicos elementos y detalles urbanitas, también se incluirán elementos propios a cada personaje que contrasten tanto con el escenario como con el otro rival para conseguir expresar la individualidad de cada uno de ellos. 
